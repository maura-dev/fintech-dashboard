      ...
      <Paper className={classes.mainCont} elevation={0}>
        <div className={classes.inputSection}>
          <Typography variant="h5" className={classes.mainTitle}>
            All Payment <span className={classes.paymentCount}>450</span>
          </Typography>
          <div>
        ...
        <div className={classes.paymentDeets}>
          ...
          <div className={classes.inputSection}>
            ...
            <div>
              ...
              <p className={classes.paymentValues}>01827345372</p> 
              <p className={classes.paymentValues}>$100.00</p> 
              <p className={classes.paymentValues}>Success</p>    
            </div>     
          </div>

          <Button variant="outlined" className={classes.deleteBtn} fullWidth>
